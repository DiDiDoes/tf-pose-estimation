...
class EfficientdetNetwork1(network_base.BaseNetwork):
    ...
    def setup(self):
        ...
        self.feed('image').base(name='efficientdet-d1')

        # for n, l in enumerate(self.layers):
        #     print(l)

        self.feed('efficientdet-d1/P4').upsample(factor='efficientdet-d1/P3', name='efficientdet-d1/P4_upsample')
        self.feed('efficientdet-d1/P5').upsample(factor='efficientdet-d1/P3', name='efficientdet-d1/P5_upsample')
        self.feed('efficientdet-d1/P6').upsample(factor='efficientdet-d1/P3', name='efficientdet-d1/P6_upsample')
        self.feed('efficientdet-d1/P7').upsample(factor='efficientdet-d1/P3', name='efficientdet-d1/P7_upsample')
        
        if True:
            (self.feed(
                'efficientdet-d1/P3',
                'efficientdet-d1/P4_upsample',
                'efficientdet-d1/P5_upsample',
                'efficientdet-d1/P6_upsample',
                'efficientdet-d1/P7_upsample',
    ...
    def restorable_variables(self, only_backbone=True):
        vs = {v.op.name: v for v in tf.global_variables() if
              ('efficientnet-b1' in v.op.name or 'resample_p6' in v.op.name or
...
if __name__ == '__main__':
    ...
    with tf.variable_scope(tf.get_variable_scope(), reuse=False):
        network1 = EfficientdetNetwork1({'image': input1})
    ...
    with tf.variable_scope(tf.get_variable_scope(), reuse=tf.AUTO_REUSE):
        network2 = EfficientdetNetwork1({'image': input1})
