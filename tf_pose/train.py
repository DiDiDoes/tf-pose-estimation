...
ch = logging.FileHandler('/data/models/baseline-fuse.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tag', type=str, default='baseline-fuse')
    parser.add_argument('--checkpoint', type=str, default='/data/models/baseline-fuse/')
